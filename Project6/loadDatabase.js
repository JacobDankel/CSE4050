...
mongoose.connect('mongodb+srv://<username>:<password>@cluster0.c73v6qn.mongodb.net/?retryWrites=true&w=majority');
...
var removePromises = [Task.deleteMany({}), TaskType.deleteMany({}), User.deleteMany({}), SchemaInfo.deleteMany({})];
...
Promise.all(removePromises).then(function () {
    ...
    var allPromises = Promise.all(taskTypePromises.concat(userPromises)).then(function () {
