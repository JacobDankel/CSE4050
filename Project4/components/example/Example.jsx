...
class Example extends React.Component {
  constructor(props) {
    ...
    this.state = {
      name: window.cse4050models.exampleModel().name,
      counter: 0,
      inputValue: '',
      buttonWasClicked: '',
    };
    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          ...
          <input type="text" value={this.state.mottoValue} onChange={this.handleChangeBound} />
          <p className="cse4050-motto-output">
            Jacob Dankel {this.state.mottoValue}
          </p>
        </div>
        ...
        <pre className="cse4050-example-code">
...
`function outOfBandJSX(option) {
  ...
  return retVal;
        ...
        <div className="cse4050-example-output">{this.outOfBandJSX(true)}</div>
        <p>
...
`
        ...
        <div className="cse4050-example-output">
          <p>
