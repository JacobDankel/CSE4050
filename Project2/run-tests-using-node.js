...
/*
 * run-test-using-node.js - Run the cse4050 project #2 test code using Node.js rather than in the
...
console.log('*********** Running cse4050 Project #2 tests ***********');

console.log('*** Loading project files ....');
processScriptFromFile('./cse4050-make-multi-filter.js');
processScriptFromFile('./cse4050-template-processor.js');

console.log('*** Running tests ....');
processScriptFromFile('./cse4050-test-project2.js');

var { p1Message, p2Message, p3Message } = global.cse4050Project2Results;

var testWorked = (p1Message === 'SUCCESS') && (p2Message === 'SUCCESS')
    && (p3Message === 'SUCCESS');

console.log(
  '*********** Running cse4050 Project #2 tests ***********:',
